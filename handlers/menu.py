# -*- coding: utf-8 -*-
# UI-only refresh: giữ nguyên callback/state/logic; trả lời công khai trong nhóm
...
async def menu_callback_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "ung_ho_gop_y":
        # Nếu ung_ho_gop_y là async: await; nếu lỡ là sync: gọi trực tiếp
        try:
            await ung_ho_gop_y(update, context)
        except TypeError:
            ung_ho_gop_y(update, context)
        return
